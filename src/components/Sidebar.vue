      ...
      <div class="p-6 border-b border-white/10 shrink-0">
        <div class="flex items-center justify-between">
          <div v-if="!isCollapsed" class="flex items-center space-x-3">
            <div
              class="w-10 h-10 bg-linear-to-br from-blue-400 to-blue-600 rounded-lg flex items-center justify-center shadow-lg"
            >
        ...
        >
          ...
          <div class="flex-1 min-w-0">
            ...
            <p class="text-xs text-white/70 truncate">
              {{ user?.email || "user@sara.com" }}
            </p>
            <p class="text-xs text-white/50 truncate capitalize">
              {{ user?.role || "" }}
            </p>
          </div>
        </div>
